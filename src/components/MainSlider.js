...
import CameraImg from "../img/main_image.jpg";
import CameraImg1 from "../img/IMG_6301.jpg";
            ...
            <SwiperSlide key={index}>
              ...
              >
                ...
                <div className="w-full lg:flex-1">
                  ...
                  <div
                    className="text-3xl md:text-[46px] font-semibold uppercase leading-none text-center lg:text-left mb-8 xl:mb-20 text-black"
                    style={{ color: "#f6cd46" }}
                  >
                    {slide.titlePart1} <br />
                    {slide.titlePart2} <br />
